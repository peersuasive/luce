...
const Luna<LStretchableLayoutResizerBar>::Inheritence LStretchableLayoutResizerBar::inherits[] = {
...
const Luna<LStretchableLayoutResizerBar>::Enum LStretchableLayoutResizerBar::enums[] = {
    {0}
};
