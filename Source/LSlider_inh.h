...
#ifndef __LUCE_LSLIDER_INH_H
#define __LUCE_LSLIDER_INH_H

// LComponent inheritage
const Luna<LSlider>::Inheritence LSlider::inherits[] = {
...
const Luna<LSlider>::Enum LSlider::enums[] = {
    { "ColourIds", {
        { "backgroundColourId", LSlider::backgroundColourId },
        { "thumbColourId", LSlider::thumbColourId },
        { "trackColourId", LSlider::trackColourId },
        { "rotarySliderFillColourId", LSlider::rotarySliderFillColourId },
        { "rotarySliderOutlineColourId", LSlider::rotarySliderOutlineColourId },
        { "textBoxTextColourId", LSlider::textBoxTextColourId },
        { "textBoxBackgroundColourId", LSlider::textBoxBackgroundColourId },
        { "textBoxHighlightColourId", LSlider::textBoxHighlightColourId },
        { "textBoxOutlineColourId", LSlider::textBoxOutlineColourId }
    }},

    { "SliderStyle", {
        { "LinearHorizontal" , LSlider::LinearHorizontal },
        { "LinearVertical" , LSlider::LinearVertical },
        { "LinearBar" , LSlider::LinearBar },
        { "LinearBarVertical" , LSlider::LinearBarVertical },
        { "Rotary" , LSlider::Rotary },
        { "RotaryHorizontalDrag" , LSlider::RotaryHorizontalDrag },
        { "RotaryVerticalDrag" , LSlider::RotaryVerticalDrag },
        { "RotaryHorizontalVerticalDrag" , LSlider::RotaryHorizontalVerticalDrag },
        { "IncDecButtons" , LSlider::IncDecButtons },
        { "TwoValueHorizontal" , LSlider::TwoValueHorizontal },
        { "TwoValueVertical" , LSlider::TwoValueVertical },
        { "ThreeValueHorizontal" , LSlider::ThreeValueHorizontal },
        { "ThreeValueVertical" , LSlider::ThreeValueVertical }
    }},

    { "IncDecButtonMode", {
        { "incDecButtonsNotDraggable" , LSlider::incDecButtonsNotDraggable },
        { "incDecButtonsDraggable_AutoDirection" , LSlider::incDecButtonsDraggable_AutoDirection },
        { "incDecButtonsDraggable_Horizontal" , LSlider::incDecButtonsDraggable_Horizontal },
