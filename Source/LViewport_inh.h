...
#ifndef __LUCE_LVIEWPORT_INH_H
#define __LUCE_LVIEWPORT_INH_H

// LComponent inheritage
const Luna<LViewport>::Inheritence LViewport::inherits[] = {
...
const Luna<LViewport>::InheritenceF LViewport::inheritsF[] = {
    method( LBase, light),
...
const Luna<LViewport>::Enum LViewport::enums[] = {
    {0}
};
#endif // __LUCE_LVIEWPORT_INH_H
