...
const Luna<LSystemTrayIconComponent>::Inheritence LSystemTrayIconComponent::inherits[] = {
...
const Luna<LSystemTrayIconComponent>::InheritenceF LSystemTrayIconComponent::inheritsF[] = {
    method( LBase, light),
...
const Luna<LSystemTrayIconComponent>::Enum LSystemTrayIconComponent::enums[] = {
    {0}
};
