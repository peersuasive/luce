...
const Luna<LDrawableComposite>::Inheritence LDrawableComposite::inherits[] = {
...
const Luna<LDrawableComposite>::InheritenceF LDrawableComposite::inheritsF[] = {
    method( LBase, light),
...
const Luna<LDrawableComposite>::Enum LDrawableComposite::enums[] = {
