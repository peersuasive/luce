...
const Luna<LDrawableShape>::Inheritence LDrawableShape::inherits[] = {
...
const Luna<LDrawableShape>::InheritenceF LDrawableShape::inheritsF[] = {
    method( LBase, light),
...
const Luna<LDrawableShape>::Enum LDrawableShape::enums[] = {
