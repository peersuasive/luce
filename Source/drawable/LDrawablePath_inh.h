...
const Luna<LDrawablePath>::Inheritence LDrawablePath::inherits[] = {
...
const Luna<LDrawablePath>::InheritenceF LDrawablePath::inheritsF[] = {
    method( LBase, light),
...
const Luna<LDrawablePath>::Enum LDrawablePath::enums[] = {
