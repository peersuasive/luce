...
const Luna<LDrawableRectangle>::Inheritence LDrawableRectangle::inherits[] = {
    {"size", &LComponent::getSize, &LComponent::setSize},
...
const Luna<LDrawableRectangle>::InheritenceF LDrawableRectangle::inheritsF[] = {
    method( LBase, light),
    ...
    // LDrawable
    //method( LDrawable, createCopy ), // virtual
    ...
    method( LDrawable, getDrawableBounds ), // overriden
    method( LDrawable, replaceColour ), // overriden

    // LDrawableShape
    method( LDrawableShape, setFill ),
    method( LDrawableShape, getFill ),
    method( LDrawableShape, setStrokeFill ),
    method( LDrawableShape, getStrokeFill ),
    method( LDrawableShape, setStrokeType ),
    method( LDrawableShape, setStrokeThickness ),
    method( LDrawableShape, getStrokeType ),
    method( LDrawableShape, hitTest ),
    //method( LDrawableShape, paint ), // wanna override this ?

    {0,0}
};

const Luna<LDrawableRectangle>::Enum LDrawableRectangle::enums[] = {
