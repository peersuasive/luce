...
// LButton inheritage
const Luna<LHyperlinkButton>::Inheritence LHyperlinkButton::inherits[] = {
    // LComponent
...
const Luna<LHyperlinkButton>::Enum LHyperlinkButton::enums[] = {
    { "ConnectedEdgeFlags", {
    ...
    { "ColourIds", {
        { "textColourId"   , HyperlinkButton::textColourId },
    }},
    {0}
};
