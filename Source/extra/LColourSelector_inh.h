...
#ifndef __LUCE_LCOLOURSELECTOR_INH_H
#define __LUCE_LCOLOURSELECTOR_INH_H

// LComponent inheritage
const Luna<LColourSelector>::Inheritence LColourSelector::inherits[] = {
...
const Luna<LColourSelector>::InheritenceF LColourSelector::inheritsF[] = {
    method( LBase, light),
...
const Luna<LColourSelector>::Enum LColourSelector::enums[] = {
    { "ColourIds", {
        { "backgroundColourId", ColourSelector::backgroundColourId },
        { "labelTextColourId", ColourSelector::labelTextColourId },
    }},

    { "ColourSelectorOptions", {
        { "showAlphaChannel", ColourSelectorOptions::showAlphaChannel },
        { "showColourAtTop", ColourSelectorOptions::showColourAtTop },
        { "showSliders", ColourSelectorOptions::showSliders },
        { "showColourspace", ColourSelectorOptions::showColourspace },
    }},

    {0}
};
#endif // __LUCE_LCOLOURSELECTOR_INH_H
