...
// LButton inheritage
const Luna<LImageButton>::Inheritence LImageButton::inherits[] = {
    // LComponent
...
const Luna<LImageButton>::InheritenceF LImageButton::inheritsF[] = {
    method( LBase, light),
...
const Luna<LImageButton>::Enum LImageButton::enums[] = {
    { "ConnectedEdgeFlags", {
