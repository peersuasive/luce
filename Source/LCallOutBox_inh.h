...
#ifndef __LUCE_LCALLOUTBOX_INH_H
#define __LUCE_LCALLOUTBOX_INH_H

// LComponent inheritage
const Luna<LCallOutBox>::Inheritence LCallOutBox::inherits[] = {
...
const Luna<LCallOutBox>::InheritenceF LCallOutBox::inheritsF[] = {
    method( LBase, light),
...
const Luna<LCallOutBox>::Enum LCallOutBox::enums[] = {
    {0}
};
#endif // __LUCE_LCALLOUTBOX_INH_H
