...
const Luna<LComboBox>::Inheritence LComboBox::inherits[] = {
...
const Luna<LComboBox>::InheritenceF LComboBox::inheritsF[] = {
    method( LBase, light),
...
const Luna<LComboBox>::Enum LComboBox::enums[] = {
    { "ColourIds", {
        { "backgroundColourId" , ComboBox::backgroundColourId },
        { "textColourId"       , ComboBox::textColourId },
        { "outlineColourId"    , ComboBox::outlineColourId },
        { "buttonColourId"     , ComboBox::buttonColourId },
    }},
