...
#ifndef __LUCE_LScrollBar_INH_H
#define __LUCE_LScrollBar_INH_H

// LComponent inheritage
const Luna<LScrollBar>::Inheritence LScrollBar::inherits[] = {
...
const Luna<LScrollBar>::InheritenceF LScrollBar::inheritsF[] = {
    method( LBase, light),
...
const Luna<LScrollBar>::Enum LScrollBar::enums[] = {
    { "ColourIds", {
        { "backgroundColourId", ScrollBar::ColourIds::backgroundColourId },
        { "thumbColourId", ScrollBar::ColourIds::thumbColourId },
        { "trackColourId", ScrollBar::ColourIds::trackColourId },
    }},

    {0}
};
#endif // __LUCE_LScrollBar_INH_H
