...
#ifndef LUCE_WEBBUFFEREDINPUTSTREAM_H_INCLUDED
#define LUCE_WEBBUFFEREDINPUTSTREAM_H_INCLUDED
...
*/
class JUCE_API  WebBufferedInputStream  : public InputStream
{
public:
    //==============================================================================
    ...
    */
    WebBufferedInputStream (InputStream* sourceStream,
                         int bufferSize,
                         bool deleteSourceWhenDestroyed, int backBufferSize = 512);
    ...
    /** Creates a BufferedInputStream from an input source.
        ...
        @param bufferSize       the size of reservoir to use to buffer the source
    */
    WebBufferedInputStream (InputStream& sourceStream, int bufferSize);
...
private:
    ...
    int bufferSize, backBufferSize;
    int64 position, lastReadPos, bufferStart, backBufferStart, bufferOverlap;
    HeapBlock<char> buffer, backBuffer;
    void ensureBuffered();

    //==============================================================================
    const int64 hugeFakeLength = std::numeric_limits<int32>::max();
    bool isInfinite;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WebBufferedInputStream)
};

#endif   // LUCE_WEBBUFFEREDINPUTSTREAM_H_INCLUDED
