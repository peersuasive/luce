...
BufferingAudioInfiniteSource::BufferingAudioInfiniteSource (PositionableAudioSource* s,
...
BufferingAudioInfiniteSource::~BufferingAudioInfiniteSource()
{
    releaseResources();
}

//==============================================================================
void BufferingAudioInfiniteSource::prepareToPlay (int samplesPerBlockExpected, double newSampleRate)
{
...
void BufferingAudioInfiniteSource::releaseResources()
{
    isPrepared = false;
    backgroundThread.removeTimeSliceClient (this);
...
void BufferingAudioInfiniteSource::getNextAudioBlock (const AudioSourceChannelInfo& info)
{
...
int64 BufferingAudioInfiniteSource::getNextReadPosition() const
{
...
void BufferingAudioInfiniteSource::setNextReadPosition (int64 newPosition)
{
    const ScopedLock sl (bufferStartPosLock);
...
bool BufferingAudioInfiniteSource::readNextBufferChunk()
{
...
void BufferingAudioInfiniteSource::readBufferSection (const int64 start, const int length, const int bufferOffset)
{
...
int BufferingAudioInfiniteSource::useTimeSlice()
{
