...
/**
    ...
    The code in juce_MP3AudioFormatInfinite.cpp is NOT guaranteed to be free from infringements of 3rd-party
...
*/
class MP3AudioFormatInfinite  : public AudioFormat
{
public:
    //==============================================================================
    MP3AudioFormatInfinite();
    ~MP3AudioFormatInfinite();
