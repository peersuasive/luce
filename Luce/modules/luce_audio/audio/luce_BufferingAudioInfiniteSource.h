...
#ifndef JUCE_BUFFERINGAUDIOINFINITESOURCE_H_INCLUDED
#define JUCE_BUFFERINGAUDIOINFINITESOURCE_H_INCLUDED
...
*/
class JUCE_API  BufferingAudioInfiniteSource  : public PositionableAudioSource,
                                                private TimeSliceClient
{
public:
    //==============================================================================
    /** Creates a BufferingAudioInfiniteSource.
    ...
    */
    BufferingAudioInfiniteSource (PositionableAudioSource* source,
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BufferingAudioInfiniteSource)
};


#endif   // JUCE_BUFFERINGAUDIOINFINITESOURCE_H_INCLUDED
